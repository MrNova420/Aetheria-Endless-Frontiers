...
const TYPE_DEFAULTS = {
  LUSH:    { temperature:18, toxicity:0,  radiation:0,  stormFreq:0.3, floraDens:0.9, faunaDens:0.8, hazard:'none',      waterLevel:10, hasWater:true  },
  BARREN:  { temperature:35, toxicity:0,  radiation:0.3,stormFreq:0.6, floraDens:0.1, faunaDens:0.2, hazard:'heat',      waterLevel:0,  hasWater:false },
  TOXIC:   { temperature:25, toxicity:0.9,radiation:0.2,stormFreq:0.5, floraDens:0.5, faunaDens:0.4, hazard:'toxic',     waterLevel:5,  hasWater:true  },
  FROZEN:  { temperature:-40,toxicity:0,  radiation:0,  stormFreq:0.4, floraDens:0.2, faunaDens:0.3, hazard:'cold',      waterLevel:8,  hasWater:true  },
  BURNING: { temperature:80, toxicity:0.3,radiation:0.5,stormFreq:0.8, floraDens:0.0, faunaDens:0.1, hazard:'heat',      waterLevel:0,  hasWater:false },
  EXOTIC:  { temperature:22, toxicity:0.1,radiation:0.1,stormFreq:0.2, floraDens:1.0, faunaDens:1.0, hazard:'exotic',    waterLevel:12, hasWater:true  },
  DEAD:    { temperature:10, toxicity:0,  radiation:0.8,stormFreq:0.1, floraDens:0.0, faunaDens:0.0, hazard:'radiation', waterLevel:0,  hasWater:false },
  OCEAN:   { temperature:15, toxicity:0,  radiation:0,  stormFreq:0.4, floraDens:0.6, faunaDens:0.7, hazard:'none',      waterLevel:30, hasWater:true  }
};
